...
test("123 post order with correct data should receive code 201", async ({
  request,
}) => {
...
test("post order with data without status field should receive code 200", async ({
  request,
}) => {
  // Send a POST request to the server
  const response = await request.post(
...
test("post order with empty data should receive code 200", async ({
  request,
}) => {
  // Send a POST request to the server
  const response = await request.post(
